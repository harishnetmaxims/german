...
<section class="headinner">
    <div class="container">
        <h3>Update Owner</h3>
        <div class="breadcom">
            <a href="">Home</a><span> > </span> <a href="">Update Owner</a>
        </div>
    </div>
</section>
                ...
                <ul>
                    ...
                    <li><strong>ID:</strong><br>
                        <input class="input form-control" type="text" name="owner_id"
                               value="{{ utf8_decode($breedet->owner_id) }}" disabled="disabled"></li>
                    ...
                    <li><strong>Public / Private:</strong><br>
                        <select class="input form-control" name="private_pub">
                            <option value="private" {{ (($breedet->public_private == 'private')?'selected':'') }}>
                                Private
                            </option>
                            <option value="public" {{ (($breedet->public_private == 'public')?'selected':'') }}>
                                Public
                            </option>
                        </select></li>
                    ...
                    <li>
                        <input type="submit" class="button-form" value="Update Owner" name="bree_post">
