                            ...
                            <ul>
                                ...
                                <li><strong>ID:</strong><br>
                                    <input class="input form-control" type="text" name="owner_id"
                                           value="{{ utf8_decode($blogdet->indexer) }}" disabled="disabled">
                                </li>

                                <li><strong>Title:</strong><br>
                                    <input class="input form-control" type="text" name="group_name"
                                           value="{{ $blogdet->group_name }}"></li>
                                ...
                                <li><strong>Description:</strong><br>
                                    <textarea class="form-control summernote" name="group_description"
                                              value="">{{ $blogdet->group_description }}</textarea>
                                </li>
                                ...
                                <li><strong>Owner Image:</strong><br>
                                    ...
                                    <input type="file" id="imageUpload" accept="image/*" style="display: none"
                                           name="image"><br/>
                                    @if ($blogdet->image_pro)
                                    <img src="{{ url('storage/uploads/thumbs/'.$blogdet->image_pro) }}" id="profile-img-tag" width="100px" />
                                    @else
                                ...
                                <li>
                                    ...
                                    <a href="{{asset('manage-owner/'.$blogdet->indexer)}}">
                                        <button type="button" class="btn btn-theme"
                                                onClick="return confirm('Are you sure you want to delete breeder {{ $blogdet->group_name }}');">
                                            Delete Owner
                                        </button>
                                    </a>
