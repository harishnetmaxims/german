...
@section('content')
    <section id="main-content">
        <section class="wrapper">
            <div style="float:left;"><h3><i class="fa fa-angle-right"></i> Manage Elbows</h3></div>
            <div class="logout" style="float:right;"><a href="add-elbows">
                    ...
                    <div class="content-panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            <div class="col-md-12" style="padding:0px;">
                                <div class="col-md-6"><h4><i class="fa fa-angle-right"></i> All Elbows Details </h4>
                                </div>
                                <div class="col-md-6">
                                    <div class="openinput"><input type="text" class="form-control" id="selbow"
                                                                  placeholder="Search Here..." name="selbow" value="">
