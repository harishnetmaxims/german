...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script type="text/javascript" src="{{ asset('webpanel/assets/js/adminscript.js') }}"></script>
  </head>
  ...
  <section id="container" >
    <header class="header black-bg">
        ...
        <div class="top-menu">
        	<ul class="nav pull-right top-menu">
                <li><a class="logout" href="{{ asset('adminlogout') }}">Logout</a></li>
        	</ul>
        </div>
    </header>
    <style>
     ...
     <aside>
          <div id="sidebar"  class="nav-collapse ">
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a href="{{ asset('webpanel/home') }}">
                          <i class="fa fa-dashboard"></i>
                          <span>Dashboard</span>
                      </a>
                  </li>
                  <li class="mt">
                      <a href="{{ asset('webadmin/manage-logo') }}">
                          <i class="fa fa-dashboard"></i>
                          <span>Logo</span>
                      </a>
                  </li>
                     ...
                     <li class="mt">
                      <a href="{{ asset('webadmin/manage-social-profiles') }}">
                          <i class="fa fa-dashboard"></i>
                   ...
                   <li class="mt">
                      <a href="{{ asset('webadmin/manage-subscriber') }}">
                          <i class="fa fa-dashboard"></i>
                   ...
                   <li class="mt">
                      <a href="{{ asset('webadmin/change-password') }}">
                ...
                <li><a href="{{ asset('webadmin/manage-blogcat') }}" >Manage Blog Categories</a></li>
                <li><a href="{{ asset('webadmin/add-blogcat') }}" >&nbsp;&raquo;Add Blog Categories</a></li>
                <li><a href="{{ asset('webadmin/manage-blog') }}" >Manage Blog</a></li>
                <li><a href="{{ asset('webadmin/add-blog') }}" >&nbsp;&raquo;Add Blog</a></li>
                </ul>
                </li>
                ...
                <ul class="dropdown-menu" role="menu" style="float: inherit;position: inherit;">
                <li><a href="{{ asset('webadmin/manage-breeder') }}" >Manage Breeder</a></li>
                <li><a href="{{ asset('webadmin/add-breeder') }}" >&nbsp;&raquo;Add Breeder</a></li>
                </ul>
                </li>
                ...
                <ul class="dropdown-menu" role="menu" style="float: inherit;position: inherit;">
                <li><a href="{{ asset('webadmin/manage-owner') }}" >Manage Owner</a></li>
                <li><a href="{{ asset('webadmin/add-owner') }}" >&nbsp;&raquo;Add Owner</a></li>
                </ul>
                </li>
        ...
        <ul class="dropdown-menu" role="menu" style="float: inherit;position: inherit;">
          ...
          <li><a href="manage-title" >Manage Title</a></li>
                    <li><a href="{{ asset('webadmin/manage-koer') }}" >Manage Koer</a></li>
                    <li><a href="{{ asset('webadmin/manage-registry') }}" >Manage Registry</a></li>
                    <li><a href="{{ asset('webadmin/manage-hips') }}" >Manage Hips</a></li>
                    <li><a href="{{ asset('webadmin/manage-elbows') }}" >Manage Elbows</a></li>
        </ul>
        </li>
        ...
        <ul class="dropdown-menu" role="menu" style="float: inherit;position: inherit;">
          <li><a href="{{ asset('webadmin/manage-users') }}" >Manage Users</a></li>
          <li><a href="{{ asset('webadmin/add-user') }}" >Add User</a></li>
        </ul>
        </li>
                 
        <li class="">
                      <a href="{{ asset('webadmin/manage-pages') }}">
                          <i class="fa fa-dashboard"></i>
                          <span>Pages</span>
                      </a>
                </li>
        ...
        <ul class="dropdown-menu" role="menu" style="float: inherit;position: inherit;">
          ...
          <li><a href="{{ asset('webadmin/manage-pedigree') }}" >Pedigree</a></li>
          <li><a href="{{ asset('webadmin/manage-picture') }}" >Picture</a></li>
          <li><a href="{{ asset('webadmin/manage-video') }}" >Video</a></li>
        </ul>
        </li>
    ...
    <script class="include" type="text/javascript" src="{{asset('webpanel/assets/js/jquery.dcjqaccordion.2.7.js')}}"></script>
