                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="content-panel">
                            ...
                            <form method="post" name="blog_form" id="blog_form" action="{{ route('add-koer') }}" enctype="multipart/form-data">
                                @csrf
                                <ul>
                                    ...
                                    <li>
                                        <input type="submit" class="button-form" value="Submit Koer" name="blog_post">
