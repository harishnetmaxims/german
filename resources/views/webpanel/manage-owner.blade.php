...
@section('content')
    <section id="main-content">
        <section class="wrapper">
            <div style="float:left;"><h3><i class="fa fa-angle-right"></i> Manage Owner</h3></div>
            <div class="logout" style="float:right;"><a href="add-owner">
                    ...
                    <div class="content-panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            <div class="col-md-12" style="padding:0px;">
                                ...
                                <div class="col-md-6">
                                    <div class="openinput"><input type="text" class="form-control" id="sowner"
                                ...
                                @foreach($ret as $index=>$row)
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%">{{ $row->group_name }}</td>
                                        <td width="20%">{!! substr($row->group_description, 0, 100) !!}</td>
                                        <td width="10%">{{ $row->public_private }}</td>
                                        <td width="10%"></td>
                                        <td width="10%">@if ($row->todays_date) {{ date('m/d/Y H:i:s', strtotime($row->todays_date)) }} @endif</td>
                                        <td width="10%">
                                            <a href="update-owner/{{ $row->indexer }}">
                                                <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>
                                                </button>
                                            </a>
                                            <a href="delete-owner/{{ $row->indexer }}">
                                                <button class="btn btn-danger btn-xs" onClick="return confirm('Are you sure you want to delete breeder {{ $row->group_name }}')">
