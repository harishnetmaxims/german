...
@section('content')
    <section id="main-content">
        <section class="wrapper">
            <div style="float:left;"><h3><i class="fa fa-angle-right"></i> Manage Blog</h3></div>
            <div class="logout" style="float:right;"><a href="add-blog">
                    ...
                    <div class="content-panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            <div class="col-md-12" style="padding:0px;">
                                <div class="col-md-6"><h4><i class="fa fa-angle-right"></i> All Blog Details </h4></div>
                                <div class="col-md-6">
                                    <div class="openinput"><input type="text" class="form-control" id="sblog"
                                                                  placeholder="Search Here..." name="sblog" value="">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%">{{ substr($row->description, 0, 100) }}</td>
                                        ...
                                        <td width="10%">
                                            ...
                                            <a href="delete-blog/{{ $row->indexer }}">
                                                <button class="btn btn-danger btn-xs"
                                                        onClick="return confirm('Are you sure you want to delete blog {{ $row->title }}');">
