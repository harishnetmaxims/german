                ...
                <input type="text" name="user_id" value="{{$user_id}}" style="display: none;">
                    ...
                    <div class="form-group">
                        <label for="Your Album" class="pt-5"> <strong>Your Albums:</strong> Select from one of your albums. </label><br>
                            <select class="form-control" id="exampleFormControlSelect1" name="album_select" >
      ...
      <div class="modal-content">
        ...
        <form action="{{route('create_album')}}" method="Post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="album_name" >
            </div>
            <div class="form-group">
                <label for="exampleFormControlTextarea1">Description</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="alb_description"></textarea>
            </div>
            <small>(BBC or HTML code is not allowed)</small>
            <div class="form-group">
                <label for="tag"> <strong>Tags: </strong> </label>
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="alb_tag">
            </div>
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" value="public" name="alb_type">
                <label class="form-check-label" for="inlineRadio1">Public</label>
            </div>
            <div class="form-check mt-3">
                <input class="form-check-input" type="radio"  value="private" name="alb_type">
